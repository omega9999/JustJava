...
public final class EmailIntentBuilder {
     ...
     *
     * @param context The {@code Context} that will be used to launch the intent
     ...
     *
     * @param to the email addresses to add
     * @return This {@code EmailIntentBuilder} for method chaining
     */
    @NonNull
     ...
     *
     * @param cc the email address to add
     * @return This {@code EmailIntentBuilder} for method chaining
     */
    @NonNull
     ...
     * Add an email address to be used in the "cc" field.
     *
     * @param cc the email addresses to add
     * @return This {@code EmailIntentBuilder} for method chaining
     */
    @NonNull
     ...
     *
     * @param bcc the email address to add
     * @return This {@code EmailIntentBuilder} for method chaining
     */
    @NonNull
     ...
     * Add an email address to be used in the "bcc" field.
     *
     * @param bcc the email addresses to add
     * @return This {@code EmailIntentBuilder} for method chaining
     */
    @NonNull
